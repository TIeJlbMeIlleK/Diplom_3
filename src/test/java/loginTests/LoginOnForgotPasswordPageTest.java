...
import pageObjects.ForgotPasswordPageLocators;
import pageObjects.HomePageLocators;
import pageObjects.LoginPageLocators;

import static org.junit.Assert.assertTrue;

public class LoginOnForgotPasswordPageTest {
    WebDriver driver;
    ...
    public void test() {
        ...
        loginPageLocators.clickOnForgotPasswordButton();

        ForgotPasswordPageLocators forgotPasswordPageLocators = new ForgotPasswordPageLocators(driver);
        forgotPasswordPageLocators.waitForOpenPage();
        forgotPasswordPageLocators.clickOnLoginButton();
